...
public class GoodController {
    ...
    public Result findPage(
        ...
        return Result.success(goodService.findPage(pageNum,pageSize,searchText,categoryId,sortBy));
    }
    @GetMapping("/fullPage")
    public Result findFullPage(
        ...
        return Result.success(goodService.findFullPage(pageNum,pageSize,searchText,categoryId,sortBy));
    }

    @GetMapping("/delivery-addresses")
    public Result getDeliveryAddresses() {
        return Result.success(goodService.getDeliveryAddresses());
    }
}
